// Replaced next/image and next/link for Astro
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
            ...
            <div className="p-5 text-center">
                ...
                <a href="#" className="inline-flex items-center text-gray-400 group-hover:text-action text-sm font-bold transition-colors">
